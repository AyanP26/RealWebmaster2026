import { Apple, HeartPulse, BookOpen, HandHeart, Palette, Briefcase, Home as HomeIcon, MapPin } from "lucide-react";
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white relative overflow-hidden">

      {/* Abstract Background Ribbons (Simulated via SVG and CSS blurs) */}
      <div className="absolute top-0 left-0 w-full h-[800px] overflow-hidden pointer-events-none z-0">
        <svg viewBox="0 0 1440 800" className="absolute top-0 w-full h-full opacity-80" preserveAspectRatio="xMidYMid slice">
          <path d="M-100 0 C 300 400, 600 -100, 1540 800 L -100 800 Z" fill="url(#blueGrad)" opacity="0.05" />
          <path d="M-100 200 C 400 800, 800 100, 1540 600 L -100 800 Z" fill="url(#orangeGrad)" opacity="0.04" />
          <path d="M1540 0 C 1200 300, 800 -200, -100 600 L 1540 -100 Z" stroke="url(#blueGrad)" strokeWidth="40" fill="none" opacity="0.1" />
          <path d="M1540 200 C 1000 700, 400 0, -100 800" stroke="url(#orangeGrad)" strokeWidth="60" fill="none" opacity="0.1" />
      ...
      <main className="flex-grow relative z-10 w-full flex flex-col items-center">
        ...
        {/* HERO SECTION */}
        <section className="w-full max-w-5xl mx-auto px-6 pt-24 pb-16 flex flex-col items-center text-center">
          <h1 className="text-5xl md:text-6xl lg:text-[4rem] font-bold text-primary-blue mb-6 tracking-tight leading-tight max-w-3xl">
            Connect, Discover, and Grow in Your Community
          </h1>
          <p className="text-lg text-gray-600 mb-10 max-w-2xl font-medium leading-relaxed">
            Find local resources, events, support, and connections in your neighborhood. Weave your way into a vibrant local network.
          </p>
          ...
          <p className="text-sm font-semibold text-gray-500 mb-4 tracking-wide">
            Beautifully designed, friendly quick-access category pills
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 w-full max-w-4xl">
            ...
            <Link href="/category/government" className="flex items-center space-x-2 bg-accent-orange hover:bg-orange-600 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-transform hover:scale-105 shadow-md shadow-orange-500/20 sm:flex">
              <Briefcase className="w-4 h-4" />
              <span>Government & Legal</span>
            </Link>
            <Link href="/category/community" className="flex items-center space-x-2 bg-primary-blue hover:bg-blue-700 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-transform hover:scale-105 shadow-md shadow-blue-500/20 sm:flex">
              <HandHeart className="w-4 h-4" />
              <span>Community & Rec</span>
            </Link>
            <Link href="/category/restaurants" className="flex items-center space-x-2 bg-accent-orange hover:bg-orange-600 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-transform hover:scale-105 shadow-md shadow-orange-500/20 md:flex">
