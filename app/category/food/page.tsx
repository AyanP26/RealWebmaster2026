...
async function getCategoryResources(): Promise<CommunityResource[]> {
    ...
    return allResources.filter(resource => resource.category === "Food & Basic Needs");
}
                ...
                <section className="w-full bg-blue-50 pt-24 pb-16 px-6 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10 text-center flex flex-col items-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
                            Food & Basic Needs <br className="hidden md:block" /> in Northern Virginia
                        </h1>
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed">
                            Access essential resources including food pantries, emergency meals, and basic living supplies for individuals and families in Northern Virginia.
                        </p>

                        <div className="mt-10 flex gap-4">
                            <Link href="/search?q=Food%20%26%20Basic%20Needs" className="flex items-center space-x-2 bg-white text-gray-700 hover:text-primary-blue px-6 py-3 rounded-full font-semibold shadow-sm border border-gray-200 transition-colors">
