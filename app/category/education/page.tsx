...
async function getCategoryResources(): Promise<CommunityResource[]> {
    ...
    return allResources.filter(resource => resource.category === "Education & Libraries");
}
                ...
                <section className="w-full bg-blue-50 pt-24 pb-16 px-6 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10 text-center flex flex-col items-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
                            Education & Libraries <br className="hidden md:block" /> in Northern Virginia
                        </h1>
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed">
                            Discover public libraries, after-school programs, tutoring services, and educational resources for all ages.
                        </p>

                        <div className="mt-10 flex gap-4">
                            <Link href="/search?q=Education" className="flex items-center space-x-2 bg-white text-gray-700 hover:text-primary-blue px-6 py-3 rounded-full font-semibold shadow-sm border border-gray-200 transition-colors">
