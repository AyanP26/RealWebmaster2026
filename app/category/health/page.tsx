...
async function getCategoryResources(): Promise<CommunityResource[]> {
    ...
    return allResources.filter(resource => resource.category === "Healthcare & Mental Health");
}
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans bg-gray-50 relative">
            ...
            <main className="flex-grow w-full flex flex-col items-center pb-20">
                <section className="w-full bg-orange-50 pt-24 pb-16 px-6 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10 text-center flex flex-col items-center">
                        <div className="p-4 bg-white rounded-full shadow-md mb-6 text-accent-orange">
                            <HeartPulse className="w-10 h-10" />
                        </div>
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
                            Healthcare & Mental Health <br className="hidden md:block" /> in Northern Virginia
                        </h1>
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed">
                            Find critical healthcare services, affordable clinics, and mental health counseling centers dedicated to community wellness.
                        </p>

                        <div className="mt-10 flex gap-4">
                            <Link href="/search?q=Healthcare" className="flex items-center space-x-2 bg-white text-gray-700 hover:text-accent-orange px-6 py-3 rounded-full font-semibold shadow-sm border border-gray-200 transition-colors">
